...
fig.figure.savefig(f"{png_plot_dir}smax_prob_of_improvement.png", bbox_inches="tight")
if SAVE_PDF:
    fig.figure.savefig(f"{pdf_plot_dir}smax_prob_of_improvement.pdf", bbox_inches="tight")
...
fig.figure.savefig(f"{png_plot_dir}smax_aggregate_scores.png", bbox_inches="tight")
if SAVE_PDF:
    fig.figure.savefig(f"{pdf_plot_dir}smax_aggregate_scores.pdf", bbox_inches="tight")
...
fig.figure.savefig(f"{png_plot_dir}smax_performance_profile.png", bbox_inches="tight")
if SAVE_PDF:
    fig.figure.savefig(f"{pdf_plot_dir}smax_performance_profile.pdf", bbox_inches="tight")
...
fig.figure.savefig(
    f"{png_plot_dir}smax_env_agg_return.png", bbox_inches="tight"
)
if SAVE_PDF:
    fig.figure.savefig(
        f"{pdf_plot_dir}smax_env_agg_return.pdf", bbox_inches="tight"
    )